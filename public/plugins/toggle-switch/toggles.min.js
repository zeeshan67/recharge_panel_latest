 ...
 */
    $.fn.toggles = function (d) {
        ...
        return this.each(function () {
            ...
            b && f || (e.height(b = a.height), e.width(f = a.width));
            ...
            a.on && p(c, f, b);
            if (a.click && (!a.clicker || !a.clicker.has(e).length))e.on("click touchstart", function (b) {
                b.stopPropagation();
                b.target == h[0] && a.drag || c.trigger("toggle", c.hasClass("active"))
            });
            if (a.clicker)a.clicker.on("click touchstart", function (b) {
                b.stopPropagation();
                b.target == h[0] && a.drag || c.trigger("toggle", c.hasClass("active"))
            });
            if (a.drag && !k) {
                var g, u = (f -
                    b) / 4, v = function (k) {
                    e.off("mousemove touchmove");
                    c.off("mouseleave");
                    h.off("mouseup touchend");
                ...
                h.on("mousedown touchstart", function (a) {
                    g = 0;
                    h.off("mouseup touchend");
                    c.off("mouseleave");
                    var b = a.pageX;
                    e.on("mousemove touchmove", h, function (a) {
                        g = a.pageX - b;
                        c.hasClass("active") ? (a =
                            g, 0 < g && (a = 0), g < n && (a = n)) : (a = g + n, 0 > g && (a = n), g > -n && (a = 0));
                        d.css("margin-left", a)
                    });
                    h.on("mouseup touchend", v);
                    c.on("mouseleave", v)
                })
            }
        })
