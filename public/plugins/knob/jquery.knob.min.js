...
!function (a) {
    ...
    b.c = {}, b.c.d = a(document), b.c.t = function (a) {
        ...
        b.o.call(this), this.startAngle = null, this.xy = null, this.radius = null, this.lineWidth = null, this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function () {
            ...
            var f, g, b = this, e = function (a) {
                a.preventDefault();
                var c = a.originalEvent, d = c.detail || c.wheelDeltaX, e = c.detail || c.wheelDeltaY, f = parseInt(b.$.val()) + (d > 0 || e > 0 ? b.o.step : 0 > d || 0 > e ? -b.o.step : 0);
                b.cH && b.cH(f) === !1 || b.val(f)
            }, h = 1, i = {37: -b.o.step, 38: b.o.step, 39: b.o.step, 40: -b.o.step};
            this.$.bind("keydown", function (e) {
                ...
                if (j >= 96 && 105 >= j && (j = e.keyCode = j - 48), f = parseInt(String.fromCharCode(j)), isNaN(f) && (13 !== j && 8 !== j && 9 !== j && 189 !== j && e.preventDefault(), a.inArray(j, [37, 38, 39, 40]) > -1)) {
                    ...
                    b.o.stopper && (k = c(d(k, b.o.max), b.o.min)), b.change(k), b._draw(), g = window.setTimeout(function () {
                        h *= 2
                    }, 30)
                }
            }).bind("keyup", function () {
                isNaN(f) ? g && (window.clearTimeout(g), g = null, h = 1, b.val(b.$.val())) : b.$.val() > b.o.max && b.$.val(b.o.max) || b.$.val() < b.o.min && b.$.val(b.o.min)
            }), this.$c.bind("mousewheel DOMMouseScroll", e), this.$.bind("mousewheel DOMMouseScroll", e)
        }, this.init = function () {
